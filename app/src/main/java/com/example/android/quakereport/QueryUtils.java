...
public class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEartquakes(String jsonString) {

        ArrayList<Earthquake> result = new ArrayList<>();

        try {
            JSONObject root = new JSONObject(jsonString);
            JSONArray features = root.getJSONArray(KEY_FEATURES);
            ...
            Log.e(LOG_TAG, "Error reading JSON");
        }
        return result;
    }
